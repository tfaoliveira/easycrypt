...
type cckey. (* chacha key *)
type cct1.  (* input of the permutation *)
type cct2.  (* output of the permutation *)

type polykey, polyt1, polyt2, polyt4.
     (* poly key, 
        polyt1: type of polynome 
        polyt2: result type of polynome evaluation 
        polyt4: type of tag  *)
